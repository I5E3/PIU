...
public class GroupController {
    ...
    public void main(HttpSession session,Model model, Criteria criteria){
        ...
        model.addAttribute("projectList", projectService.getUserProjectList(userNum,criteria ));
        model.addAttribute("pageDTO", new PageDTO(criteria, projectService.getUserProjectTotal(userNum)));
